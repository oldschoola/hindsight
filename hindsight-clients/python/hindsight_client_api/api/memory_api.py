...
from hindsight_client_api.models.purge_invalidated_request import PurgeInvalidatedRequest
from hindsight_client_api.models.purge_invalidated_response import PurgeInvalidatedResponse
...
class MemoryApi:
    ...
    async def purge_invalidated_memories(
        ...
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        purge_invalidated_request: Optional[PurgeInvalidatedRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param authorization:
        :type authorization: str
        :param purge_invalidated_request:
        :type purge_invalidated_request: PurgeInvalidatedRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._purge_invalidated_memories_serialize(
            bank_id=bank_id,
            authorization=authorization,
            purge_invalidated_request=purge_invalidated_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def purge_invalidated_memories_with_http_info(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        purge_invalidated_request: Optional[PurgeInvalidatedRequest] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurgeInvalidatedResponse]:
        """Purge invalidated memories
    ...
    @validate_call
    async def purge_invalidated_memories_without_preload_content(
        self,
        bank_id: StrictStr,
        authorization: Optional[StrictStr] = None,
        purge_invalidated_request: Optional[PurgeInvalidatedRequest] = None,
    ...
    def _purge_invalidated_memories_serialize(
        self,
        bank_id,
        authorization,
        purge_invalidated_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if purge_invalidated_request is not None:
            _body_params = purge_invalidated_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/memories/purge-invalidated',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
